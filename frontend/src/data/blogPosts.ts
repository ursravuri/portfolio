...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      'API governance at enterprise scale demands more than documentation standards. This article presents a layered governance model that balances developer agility with organizational control across hundreds of APIs.',
...
- Measure governance effectiveness through API consistency scores, not compliance checklists.`,
  ...
  },
  {
    ...
    category: 'API Management',
    excerpt:
      'Large organizations often struggle with fragmented API practices across teams. This article outlines a unified lifecycle approach — from design through retirement — that brings coherence without killing velocity.',
...
- Retirement is as important as creation — unmanaged API sprawl is a security and operational liability.`,
  ...
  },
  {
    ...
    excerpt:
      'API gateways are evolving from simple traffic managers to intelligent security enforcement points. This article examines the architectural shifts driving the next generation of gateway platforms.',
...
- The future architecture combines API gateways (north-south) with service meshes (east-west) under unified governance.`,
  ...
  },
  {
    ...
    category: 'API Management',
    excerpt:
      'APIs are products, not projects. This article lays out the strategy and architecture for transforming internal services into monetizable, self-service digital assets with proper packaging, pricing, and developer experience.',
...
- API productization transforms cost centers (internal services) into revenue generators (digital assets).`,
  ...
  },
  {
    ...
    category: 'Security',
    excerpt:
      'Enterprise environments rarely have a single identity provider. This article details patterns for validating JWTs from multiple issuers — handling key rotation, claim mapping, and trust chain management at the API gateway.',
...
- Always validate the \`iss\` claim against an allowlist — never accept tokens from unknown issuers.`,
  ...
  },
  {
    ...
    category: 'Security',
    excerpt:
      'OAuth 2.0 is powerful but unforgiving of misconfigurations. This article catalogs the most dangerous OAuth pitfalls in enterprise API platforms and provides concrete remediation patterns.',
...
- Redirect URI validation must be exact match; wildcards create authorization code theft vulnerabilities.`,
  ...
  },
  {
    ...
    category: 'Security',
    excerpt:
      'Zero-trust is a philosophy, not a product. This article provides a concrete implementation blueprint for applying zero-trust principles to API traffic using IBM DataPower and API Connect.',
...
- Continuous monitoring and anomaly detection complete the zero-trust model — you cannot trust what you cannot see.`,
  ...
  },
  {
    ...
    category: 'Security',
    excerpt:
      'PKI is the backbone of API transport security, but most enterprises manage it poorly. This article presents an architecture for automated, governed PKI that scales with your API ecosystem.',
...
- Monitor certificate expiry proactively — expired certificates cause cascading API outages.`,
  ...
  },
  {
    ...
    category: 'Middleware',
    excerpt:
      'Downtime in integration middleware cascades to every connected system. This article architects a high-availability integration layer using IBM MQ, DataPower, and API Connect with concrete patterns for failover, scaling, and disaster recovery.',
...
- Define RTO/RPO targets per component and validate them through regular DR testing.`,
  ...
  },
  {
    ...
    category: 'Middleware',
    excerpt:
      'GatewayScript is DataPower\'s JavaScript runtime for custom API processing. This article presents battle-tested patterns for logging, transformation, security enforcement, and error handling.',
...
- Build reusable GatewayScript modules — shared libraries reduce duplication and improve maintainability.`,
  ...
  },
  {
    ...
    category: 'Enterprise Architecture',
    excerpt:
      'Legacy integration systems cannot be replaced overnight. This article provides a phased modernization blueprint that introduces modern API patterns while preserving existing investments in MQ, CICS, and mainframe connectivity.',
...
- Measure modernization progress through the percentage of traffic flowing through modern APIs vs. legacy protocols.`,
  ...
  },
  {
    ...
    excerpt:
      'Most middleware monitoring focuses on uptime and throughput. This article defines the observability metrics that actually matter for API platforms — from latency percentiles to consumer health scoring.',
...
- Alert on capacity utilization at 70% to maintain headroom for traffic spikes.`,
  ...
  },
  {
    ...
    category: 'Enterprise Architecture',
    excerpt:
      'API architects face dozens of design decisions on every project. This article provides structured decision trees for the most common architectural choices — from protocol selection to caching strategy.',
...
- Version only when you must (breaking changes) and prefer URL versioning for external APIs due to its simplicity.`,
  ...
  },
  {
    ...
    category: 'Enterprise Architecture',
    excerpt:
      'Enterprises need more than point-to-point integrations — they need an integration fabric that connects all systems through a coherent, governed platform. This article defines the architecture.',
...
- Measure fabric health through integration count, traffic volume, error rates, and consumer onboarding time.`,
  ...
  },
  {
    ...
    category: 'Enterprise Architecture',
    excerpt:
      'The next decade of enterprise architecture will be defined by ecosystems, not applications. This article establishes the architectural principles for building digital ecosystems that are secure, scalable, and sustainable.',
